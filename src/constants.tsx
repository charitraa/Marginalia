 ...
 * builds (for example https://api.mindfulblog.com).
 */
...
export const SESSION_FLAG_KEY = "mindful.session";
...
export const SITE_DESCRIPTION =
  "Thoughtful stories, ideas, tutorials and experiences from the Mindful Blog community.";
